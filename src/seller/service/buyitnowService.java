...
public void insert(Product product, BinProduct binproduct, String category, String subcategory ) {
				...
				/*try {
					...
					try {
						...
						//to retrieve categoryId based on the category
							...
							query5 = "INSERT INTO binproduct(productId, stock, binPrice) VALUES(?,?,?)";

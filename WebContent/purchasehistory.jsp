...
<tr>
	...
	<td align="center"><b>Payment Confirmation (From Bank)</b></td>
	<td align="center"><b>Receipt Confirmation (From Buyer)</b></td>
	<td align="center"><b>Purchase Date</b></td>
	<td align="center"><b>Grand Total</b></td>
	<td align="center"><b>ETD</b></td>
...
<tr>
	...
	<td align="center">
		...
		<s:elseif test="recieptConfirmation == 2">Not Received
			<s:if test="shipmentStatus=='shipped'">
				<s:a href="receiptConfirmationShow.action?cartId=%{cartId}&recieptConfirmation=%{recieptConfirmation}&shipmentStatus=%{shipmentStatus}">( Change status )
				</s:a>
			</s:if>
		</s:elseif>
		<s:else>Failure</s:else> 
	...
	<td align="center"><s:property value="ETD"/> Days</td>
